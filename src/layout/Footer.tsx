...
import latestNews_1 from "../../public/assets/img/footer/latest-news1.jpg";
import latestNews_2 from "../../public/assets/img/footer/latest-news2.jpg";
                     ...
                     <div className="footer-counter-wrap">
                        <div className="counter-item counter-text-wrap">
                           ...
                           <div className="counter-item__content">
                              <span className="count-text" data-speed="3000" data-stop="876000">876000</span>
                        ...
                        <div className="counter-item counter-text-wrap">
                           ...
                           <div className="counter-item__content">
                              <span className="count-text" data-speed="3000" data-stop="45000">45000</span>
