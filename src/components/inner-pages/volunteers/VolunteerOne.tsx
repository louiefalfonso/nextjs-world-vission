...
import volunteerShape_1 from "../../../../public/assets/img/shapes/hand-glass.png"
import volunteerShape_2 from "../../../../public/assets/img/shapes/circle-with-line-red.png";
import volunteerShape_3 from "../../../../public/assets/img/shapes/heart.png";
import volunteerShape_4 from "../../../../public/assets/img/shapes/house-heart.png";

const VolunteerOne = ({ style }: any) => {
            ...
            <div className="row justify-content-center">
               <div className="col-xl-6 col-lg-8 col-md-10">
                  <div className="section-title text-center mb-60">
                     ...
                     {style ? <h3>Meet <span>With Volunteers</span></h3> : <h2>Our <span>Volunteers</span></h2>}
